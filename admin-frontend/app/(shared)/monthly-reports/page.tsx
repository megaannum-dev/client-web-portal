  ...
  return (
    <div className="mx-auto flex max-w-[1180px] flex-col gap-8 pb-8">
      ...
      <PageHeader
        ...
        subtitle="Download your end-of-month portfolio and operations statements."
      />
      ...
      <section>
        ...
        <div className="flex items-center justify-between mt-4 px-1">
          <span className="text-body-sm text-secondary">
            Showing {(currentPage - 1) * PAGE_SIZE + 1}–{Math.min(currentPage * PAGE_SIZE, MOCK_EOM_REPORTS.length)} of {MOCK_EOM_REPORTS.length}
          </span>
