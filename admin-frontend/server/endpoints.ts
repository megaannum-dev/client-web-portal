...
export const ENDPOINTS = {
  ...
  COMPLIANCE: {
    ...
    ONBOARDING_REPROVISION: (id: string) => `${COMPLIANCE}/onboardings/${id}/request-reprovision`,
    ONBOARDING_RESUBMIT:    (id: string) => `${COMPLIANCE}/onboardings/${id}/request-resubmit`,
